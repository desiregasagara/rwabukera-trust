...
const AboutContent = () =>{
    return(
        ...
        <div id="aboutcontent" className={styles.aboutcontentDiv}>
            ...
            <p>The Rwabukera Trust was esablished by the Rwabukera Family in 2009.The family are of Rwandan origin with global connections. The trustees hold, manage and invest the assets of members, where funds are available, to assist members of the Rwabukera family and others financially.</p>
            <p>The Rwabukera Trust has been established to provide funding which furthers the aims of the Rwabukera Trust: </p>
